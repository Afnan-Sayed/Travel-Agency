...
public class ExternalEventProviderAPI {
    ...
    private ExternalEventProviderAPI() {
        ...
        Event e1 = new Event();
        e1.eventID = 1; e1.name = "Pyramids Music Festival"; e1.date = new Date(125, Calendar.JANUARY, 22); e1.description = "Join the unforgettable music festival by the pyramids of Giza, featuring electronic beats and stunning views!";
        ...
        Event e2 = new Event();
        e2.eventID = 2; e2.name = "Artificial Intelligence Conference in Cairo University"; e2.date = new Date(125, Calendar.JANUARY, 24); e2.description = "AI conference featuring talks and workshops led by AI experts!";
        ...
        Event e3 = new Event();
        e3.eventID = 3; e3.name = "Egyptian Museum Tour"; e3.date = new Date(125, Calendar.JANUARY, 29); e3.description = "Explore the wonders of Egyptian history!";
        ...
        Event e5 = new Event();
        e5.eventID = 5; e5.name = "Christmas Eve Party in Cairo"; e5.date = new Date(124, Calendar.DECEMBER, 31); e5.description = "Enjoy New Years Eve with us in Cairo!";
