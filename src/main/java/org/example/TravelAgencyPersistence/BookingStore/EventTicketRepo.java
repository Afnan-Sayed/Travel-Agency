...
public class EventTicketRepo {
    ...
    private EventTicketRepo() {
        ...
        e3.event = eventRepo.getAllEvents().get(2); e3.userID = 4; e3.bookingID = 5; e3.eventTicketID = 5; e3.ticketNum = 40;
        eventTickets.add(e3);

        EventTicket e4 = new EventTicket();
        e4.event = eventRepo.getAllEvents().get(3); e4.userID = 2; e4.bookingID = 4; e4.eventTicketID = 10; e4.ticketNum = 168;
        eventTickets.add(e4);

        EventTicket e5 = new EventTicket();
        e5.event = eventRepo.getAllEvents().get(4); e5.userID = 1; e5.bookingID = 10; e5.eventTicketID = 16; e5.ticketNum = 50;
        eventTickets.add(e5);

        EventTicket e6 = new EventTicket();
        e6.event = eventRepo.getAllEvents().get(0); e6.userID = 2; e6.bookingID = 11; e6.eventTicketID = 17; e5.ticketNum = 101;
        eventTickets.add(e6);

        EventTicket e7 = new EventTicket();
        e7.event = eventRepo.getAllEvents().get(1); e7.userID = 5; e7.bookingID = 20; e7.eventTicketID = 34; e7.ticketNum = 345;
        eventTickets.add(e7);
    }
